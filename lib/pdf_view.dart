...
import 'package:gdlibrary_b_1398/invoice/get_total_invoice.dart';
import 'package:gdlibrary_b_1398/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_b_1398/invoice/model/product.dart';
import 'package:gdlibrary_b_1398/preview_screen.dart';
import 'package:gdlibrary_b_1398/invoice/item_doc.dart';
...
Future<void> createPdf(
  ...
  final List<CustomRow> elements = [
    ...
    CustomRow("Sub Total", "", "", "Rp ${getSubTotal(soldProducts)}"),
    CustomRow("PPN 11%", "", "", "Rp ${getPPNTotal(soldProducts)}"),
    CustomRow("Total", "", "",
              ...
              child: pw.GridView(
                ...
                children: [
                  ...
                  pw.Text('Email',
                      style: pw.TextStyle(
                          fontSize: 10.sp, color: PdfColors.blue800)),
                  pw.Text('awesomeprocuct@gmail.com',
                      style: pw.TextStyle(
                          fontSize: 10.sp, color: PdfColors.blue800)),
                ],
              ),
